var suite = {
		...
		"access original context from deferred chain": {
			...
			"$(some).animate(options,$).doThisLater()._.doThatNow()": function(){},

			"$(some).fadeIn($)._": function(){},

			"$(some).fadeOut(speed,$)._": function(){},

			"$(some).toggle($)._": function(){},

		},
		
		"access original context from instant chain": {
		},
		
		"access original context from looped chain": {
		},
