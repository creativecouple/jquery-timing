...
(function($){
	...
	/**
	 * constant token for internal usage to perceive concatenated calls of #repeat, #wait, and #until
	 */
	EASY_TIMING = {};
	 ...
	 * @param context the method context to be faked
	 * @param _repeat internally used data object for concatenated calls of #repeat, #wait, and #until
	 */
	 ...
	 * @param _repeat internally used data object for concatenated calls of #repeat, #wait, and #until
	 * @param _callStack internally used data object for concatenated calls of #repeat, #wait, and #until
	 */
	 ...
	 * </ul>
	 * @param _repeat internally used data object to perceive concatenated calls of #repeat, #wait, and #until
	 */
